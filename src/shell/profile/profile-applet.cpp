...
{
    auto schemaPath = QString("%1/%2/").arg(APPLET_SCHEMA_PATH).arg(this->m_uid);
    this->m_settings = new QGSettings(APPLET_SCHEMA_ID, schemaPath.toUtf8(), this);
...
void ProfileApplet::initSettings()
{
    ...
    this->updateSettings(APPLET_SCHEMA_KEY_ID);
    this->updateSettings(APPLET_SCHEMA_KEY_PANEL);
    this->updateSettings(APPLET_SCHEMA_KEY_POSITION);
    this->updateSettings(APPLET_SCHEMA_KEY_PRS);
