...
#define KS_ICON_MENU_GROUP_SYMBOLIC "kcp-ks-menu-group-symbolic"
...
#define KS_ICON_POWER_SUSPEND "kcp-ks-power-suspend"
#define KS_ICON_POWER_HIBERNATE "kcp-ks-power-hibernate"
