...
void NetConfItem::init()
{
    ...
    connect(this, &HwConfItem::iconClicked, this, &NetConfItem::netIconClicked);
    connect(this, &HwConfItem::settingClicked, this, &NetConfItem::netSettingClicked);
...
void NetConfItem::initUI()
{
    ...
    connect(m_backBtn, &QToolButton::clicked, this, &HwConfItem::requestExitOnlyShow);
}
